...
# A script to convert word 2 vec, using Gensim
# Word2drink
# by cqx931 2018.05
...
source_text = u""
source_path = file_name + "_processed.txt"
output_path = '../word_vector_pretrained_data/' + file_name +"/"
...
for sentence in sentences:
    for word in sentence:
        try:
            ...
            # CQX: if plural noun -> count as singular noun
...
with open(output_path+ file_name +"_gensim_result.json", 'w') as fp:
